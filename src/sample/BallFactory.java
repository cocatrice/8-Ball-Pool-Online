  ...
  public   boolean isFaul=true;
    ...
    public BallFactory(Group root,Scene scene) {
       ...
       // indicator.setLayoutY(ball[15].sphere.getLayoutY());
        ...
        msg = new Text("*************************");
        msg.setFont(Font.font("Calibri", FontWeight.THIN,30));
...
*/
        ...
        for (int i = 0; i < 16; i++) {
            ...
            if (distance1 < 20 - 2 || distance2 < 20 - 2 || distance3 < 20 - 2 || distance4 < 20 - 2 || distance5 < 20 - 2 || distance6 < 20 - 2) {
                if (turn.getTurn() && ballStorage.solidballsize == 0 && ballStorage.stripeballsize == 0) {
                    if (i < 7) {
                        myballtype = 0;
                        msg.setText("******You are Solids******");
                    } else if (i > 7 && i < 15) {
                        myballtype = 1;
                        msg.setText("******You are Stripes*******");
                    }
                }
                ...
                if (turn.getTurn() && i < 7) {
                    ...
                    if (myballtype == 1) {
                        isplay = true;
                        turn.setTurn(false);
                        msg.setText("You should put stripes ball");
                    }
    ...
    public void setDirection(){
            if(isTouch2()){
                ...
                //storeroot.getChildren().remove(direction);
               // direction.getTransforms().add(new);
            }
        }
    ...
    public void setLayout(double x,double y){
        ...
        //controllstick.setMoveStick(ball[15].sphere.getLayoutX(),ball[15].sphere.getLayoutY());
    }
